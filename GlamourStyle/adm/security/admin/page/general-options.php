...
<fieldset>
	...
	<div class="control-group">
		...
		<label class="checkbox">
			<input type="checkbox" class="input-xlarge" id="disable-logins-enable" name="disable-logins-enable" <?php echo $settings->getOption('disable-logins-enable', true); ?>>
			<?php _e('Disable logins'); ?>
		</label>
		<label class="checkbox">
	...
	<div class="control-group">
		<label class="control-label" for="restrict-signups-by-email"><?php _e('Restrict email domains'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('Restrict registrations to the emails specified.'); ?>"><i class="icon-question-sign"></i></a></label>
		<div class="controls">
			<input type="hidden" class="input-xlarge" id="restrict-signups-by-email" name="restrict-signups-by-email" data-placeholder="Domains, eg: kent.edu, gmail.com" value="<?php echo $settings->get_domains(); ?>">
		</div>
	</div>
	<div class="control-group">
