...
<div class="hero-unit">
	...
	<h2><?php _e('Easy user management and a comprehensive admin panel. All, for you :3'); ?></h2>
	<p>
		<a href="http://goo.gl/94EYi" target="_TOP" class="btn btn-info btn-large"><?php _e('Purchase this script'); ?> &raquo;</a>
		<a href="http://eepurl.com/jNgF9" class="btn btn-large" target="_blank"><?php _e('Subscribe to updates'); ?></a>
	</p>
	<p class="info-links">
		<a href="http://jigowatt.co.uk/themeforest/login/install.php" target="_blank"><?php _e('Documentation'); ?></a>
		<a href="http://codecanyon.net/item/php-login-user-management/discussion/49008" target="_blank"><?php _e('Support'); ?></a>
	</p>
</div>
